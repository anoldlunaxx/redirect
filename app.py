...
RECAPTCHA_SECRET = os.environ.get("RECAPTCHA_SECRET", "YOUR_GOOGLE_RECAPTCHA_SECRET_KEY")
TURNSTILE_SECRET = os.environ.get("TURNSTILE_SECRET", "YOUR_TURNSTILE_SECRET_KEY")
