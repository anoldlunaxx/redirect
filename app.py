...
RECAPTCHA_SECRET = os.environ.get("RECAPTCHA_SECRET", "6Ldi8u4rAAAAAJCiOkZzSCUt0to0ca1cYinnA_gh")
TURNSTILE_SECRET = os.environ.get("TURNSTILE_SECRET", "0x4AAAAAAB7Wt6wXDqvBb9oJAT9EtvHvSKA")
